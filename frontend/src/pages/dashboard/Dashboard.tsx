...
export default function Dashboard() {
  ...
  const handleSelectDoc = (docId: string) => {
    ...
    navigate(`/chat/${docId}`); // 🔥 IMPORTANT CHANGE
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex h-screen">
        ...
        {/* Sidebar */}
        <aside className={`
          fixed lg:relative inset-y-0 left-0 z-50 w-[320px]
          bg-white/3 backdrop-blur-2xl border-r border-white/10
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-3 py-4">
              <DocumentList
                ...
                setSelectedDoc={handleSelectDoc} // 🔥 IMPORTANT CHANGE
              />
            </div>
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-20 border-b border-white/10 bg-slate-950/60 backdrop-blur-xl flex items-center justify-between px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Ask questions from your PDFs</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              {openMenu && (
                <div className="absolute right-0 mt-3 w-56 rounded-2xl bg-slate-900/95 border border-white/10">
                  <button
          ...
          <section className="flex-1 flex items-center justify-center p-6">
            <div className="max-w-lg text-center">
              <div className="w-24 h-24 mx-auto rounded-3xl bg-indigo-600/10 border border-indigo-500/20 flex items-center justify-center mb-6">
              ...
              <p className="text-slate-400">
                Select a document to start chatting with your PDF.
              </p>
            </div>
          </section>
